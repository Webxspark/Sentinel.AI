...
from env import getPrivateKey, TWILIO_AUTH_TOKEN, ASSEMBLY_AI_AUTH_TOKEN, CONTRACT_ADDRESS
import random

app = Flask(__name__)
base_url = "https://api.assemblyai.com/v2"

headers = {"authorization": ASSEMBLY_AI_AUTH_TOKEN}
client = Client("ACb8b05c3a3b447064a4dc61795ef83455", TWILIO_AUTH_TOKEN);
